...
{MST (Magnosteer Control) System Development}
{
  \resumeResearchItemListStart
  \resumeResearchItem{}
  {Developed embedded \textbf{PD control algorithms with feedforward} for precision mirror movement control in LiDAR systems, implementing encoder auto-calibration and trajectory interpolation in \textbf{C/C++}.}
  \resumeResearchItem{}
