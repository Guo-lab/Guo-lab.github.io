...
import { 
  Container, Col, Row, Card, Modal, Button,
            ...
            {homeData && publicationData ? (
              <Row>
                ...
                <Col style={styles.publicationContainer}>
                  {publicationData.publications.slice().reverse().map((publication) => (
                    <Card key={publication.id} style={styles.publicationItem}>
                      
                      <Card.Body>
                        <Card.Title style={styles.title}>{publication.title}</Card.Title>
                        <Card.Subtitle style={styles.authors}>{publication.authors}</Card.Subtitle>
                        ...
                        {publication.bib && (
                          <Card.Link href="#" onClick={() => handleShowBibtex(publication.bib)}>
                            [BibTeX]
                          </Card.Link>
                        )}
